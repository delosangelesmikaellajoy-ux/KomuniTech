    ...
    <header class="bg-gradient-to-r from-primary-50 to-primary-100 border-b border-primary-200">
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between gap-4 flex-wrap">
                <div>
                    <h1 class="text-3xl font-bold text-primary-900"><i class="fas fa-file-pen mr-3"></i>Edit Document Type</h1>
                    <p class="text-primary-700 mt-1">Update file uploads, editor content, and publishing settings.</p>
                </div>
            </div>
        </div>
    </header>
