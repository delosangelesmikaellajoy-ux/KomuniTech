...
@section('header')
    <header class="bg-[#FDF5E6] shadow">
        <div class="max-w-7xl mx-auto py-4 px-6 text-[#0B1F3A] font-semibold">
            <h2 class="text-xl font-bold">Add Document Type</h2>
        </div>
    </header>
@endsection
...
<div class="max-w-4xl mx-auto mt-8 bg-[#FDF5E6] shadow-lg rounded-lg p-6">
    ...
    <form action="{{ route('admin.document_types.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="base_price" value="{{ old('base_price', 0) }}" step="0.01" min="0"
                   class="w-full border border-gray-300 rounded-lg px-4 py-2" required>
        ...
        <div class="mb-4">
            ...
            <textarea name="template_html" rows="15"
                      ...
                      placeholder="Enter HTML template here...">{{ old('template_html') }}</textarea>
        </div>
